...
use crate::font::babelfont::glyph_transactions::{LayerCloneOptions, clone_layer};
use crate::font::interpolation::{InterpolatedLayer, InterpolatedShape};
use crate::font::model::designspace::CanonicalDesignspace;
use crate::font::model::font_info::CanonicalFontInfo;
use crate::font::{CanonicalLayerSnapshot, LayerEditDraft, LayerShapeView};
...
pub(in crate::font) fn interpolated_source_layer(
...
impl CanonicalSourceStructureSnapshot {
    ...
    pub(in crate::font) fn remove_source(
        &mut self,
        source: SourceId,
    ...
    pub(in crate::font) fn add_interpolated_source(
        &mut self,
        source: SourceId,
        based_on: SourceId,
        designspace: CanonicalDesignspace,
        feature_text: String,
        font_metadata: crate::font::canonical_metadata::CanonicalFontMetadata,
