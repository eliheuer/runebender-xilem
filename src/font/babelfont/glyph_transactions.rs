...
pub(in crate::font) struct LayerCloneOptions {
...
pub(in crate::font) fn empty_layer(
    name: &str,
    id: &LayerId,
    default: bool,
    width: f64,
...
pub(in crate::font) fn duplicate_layer(
    layer: &Layer,
...
pub(in crate::font) fn clone_layer(
    layer: &Layer,
    preserved: &LayerPreservation,
    id: &LayerId,
    name: &str,
...
pub(in crate::font) fn composition_proposal_layer(
...
pub(in crate::font) fn proposal_base(layer: LayerView<'_>) -> Option<&str> {
...
pub(in crate::font) fn set_proposal_base(draft: &mut LayerEditDraft, revision: &str, reason: &str) {
...
pub(in crate::font) fn draft_matches_address(
...
pub(in crate::font) fn proposal_payload_eq(left: LayerView<'_>, right: LayerView<'_>) -> bool {
...
pub(in crate::font) fn install_proposal_payload(
...
pub(in crate::font) fn rename_layer(preserved: &mut LayerPreservation, new_name: &str) -> bool {
...
pub(in crate::font) fn rename_references(
    layer: &mut Layer,
...
mod tests {
    ...
    use super::*;
    use crate::font::babelfont::{LayerView, layer_from_ufo, project_layer};
    ...
    fn rename_updates_references_without_normalizing_metrics_source() {
        ...
        glyph.lib.insert(
            crate::font::model::glyph_metadata::LEFT_METRICS_KEY.into(),
        ...
        assert_eq!(
            projected
                .lib
                .get(crate::font::model::glyph_metadata::LEFT_METRICS_KEY)
                .and_then(plist::Value::as_string),
            Some(" = |A.alt + 1.50 ")
        );
    }
