...
#[derive(Clone, Debug)]
pub(in crate::document) struct CanonicalProposalTransaction {
...
impl Project {
    ...
    pub(in crate::document) fn begin_proposal_transaction(
        &self,
        source: SourceId,
        foreground: &LayerId,
        target: &LayerId,
    ...
    pub(in crate::document) fn commit_proposal_transaction(
        &mut self,
