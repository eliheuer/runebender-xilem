...
mod tests {
    ...
    fn new_session() -> GraphSession {
        let mut graph = nodes_live::comparison_starter(super::super::variable::SourceId(3));
        graph
            .node_mut(3)
            .unwrap()
            .values
    ...
    fn invalid_types_links_and_cycles_have_structured_addresses() {
        let mut graph = nodes_live::comparison_starter(super::super::variable::SourceId(0));
