...
const ALLOWED_BOUNDARIES: &[&str] = &[
    "document/filesystem.rs",
    "document/font_memory.rs",
    "document/model/designspace.rs",
    "document/model/font_info.rs",
    "document/model/glyph_metadata.rs",
    "document/project/constructors.rs",
    "document/project/save_as.rs",
    "document/source.rs",
    "document/source_format.rs",
    "document/ufo_codec.rs",
...
const ALLOWED_ITEMS: &[(&str, &str)] = &[
    ...
    ("document/babelfont.rs", "struct PreservedPoint"),
    ("document/babelfont.rs", "struct PreservedComponent"),
    ("document/babelfont.rs", "struct PreservedAnchor"),
    ("document/babelfont.rs", "struct ObjectMetadata"),
    ("document/babelfont.rs", "ObjectMetadata::method new"),
    ("document/babelfont.rs", "struct LayerPreservation"),
    ("document/babelfont.rs", "PointView::method name"),
    // These are the item-level import/export codecs in the otherwise live canonical module.
    ("document/babelfont.rs", "LayerImage::method from_ufo"),
    ("document/babelfont.rs", "LayerImage::method to_ufo"),
    ("document/babelfont.rs", "ImportedContours::method from_ufo"),
    ("document/babelfont.rs", "fn decode_imported_contours"),
    ("document/babelfont.rs", "fn validate_ufo_contours"),
    ("document/babelfont.rs", "fn fresh_hyper_identifier"),
    ("document/babelfont.rs", "fn fresh_object_identifier"),
    ("document/babelfont.rs", "fn ufo_contour_is_hyper"),
    ("document/babelfont.rs", "fn layer_from_ufo"),
    ("document/babelfont.rs", "fn affine"),
    ("document/babelfont.rs", "fn project_contours"),
    ("document/babelfont.rs", "fn project_layer"),
    // Canonical edits may update the private preservation record without exposing Norad.
    (
        "document/babelfont.rs",
    ...
    ("document/project.rs", "Project::method from_designspace"),
    (
        "document/project.rs",
