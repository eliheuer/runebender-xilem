...
The shared SourceTextArea adapter adds bounded local Undo/Redo before delegating ordinary editing to the pinned TextArea, preventing accidental font-history changes.
