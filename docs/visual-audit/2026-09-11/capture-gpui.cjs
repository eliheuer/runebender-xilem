...
// Usage: NODE_PATH=<playwright modules> node capture-gpui.cjs <dist> <font server URL> <output dir> <chromium executable> [--overview-inspector | --font-info | --dimensions | --kerning]
...
(async()=>{
 ...
 const sectionCaptures = {'--font-info': ['font-info',87], '--dimensions': ['dimensions',121], '--kerning': ['kerning',189]};
 if(Object.hasOwn(sectionCaptures,captureMode)) {
  ...
  await page.mouse.click(1100,headerY);
  await page.mouse.move(1279,719);
