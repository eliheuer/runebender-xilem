...
| Editable hyperbezier contour kind | Runebender contour preservation keyed by stable contour identity | Keep the semantic kind independent of the UFO identifier used to encode it | Copy, duplicate and component decomposition preserve the kind while assigning a fresh hyper-marked UFO identifier. Explicit conversion and topology-baking tools clear the kind. |
